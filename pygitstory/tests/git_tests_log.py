...
GIT_TEST_LOG = [
    GitCommit(
        ...
        author_date=datetime(2018, 6, 8, 15, 56, 25, tzinfo=TIMEZONE),
        author_name="Johann Egger",
        author_email="johann@codacy.com",
        commiter_date=datetime(2018, 6, 8, 15, 56, 25, tzinfo=TIMEZONE),
    ...
    GitCommit(
        ...
        author_date=datetime(2018, 6, 8, 15, 59, 55, tzinfo=TIMEZONE),
        author_name="Johann Egger",
        author_email="johann@codacy.com",
        commiter_date=datetime(2018, 6, 8, 15, 59, 55, tzinfo=TIMEZONE),
        commiter_name="Johann Egger",
        commiter_email="johann@codacy.com",
        message="Add a file"
    ),
    GitCommit(
        ...
        author_date=datetime(2018, 6, 8, 16, 0, 27, tzinfo=TIMEZONE),
        author_name="Johann Egger",
        author_email="johann@codacy.com",
        commiter_date=datetime(2018, 6, 8, 16, 0, 27, tzinfo=TIMEZONE),
        commiter_name="Johann Egger",
        commiter_email="johann@codacy.com",
